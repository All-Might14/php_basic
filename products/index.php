...
<body>
    <div class="flex justify-between py-4">
        ...
        <div>
            <a href="../recycle_bin/products.php" class="bg-blue-500 py-2 px-3 text-gray-100 mr-2 rounded-md">RecycleBin</a>
            ...
            <tbody>
                ...
                <tr class="border-b text-grey-100 bg-gray-800 border-gray-700">
                    ...
                    <td scope="row" class="px-6 py-4 font-medium  whitespace-nowrap text-white">
                        ...
                        <a class="px-3 py-2 bg-red-400 rounded-md" href="../products/destroy.php?id=<?php echo $product->id; ?>">delete</a>
